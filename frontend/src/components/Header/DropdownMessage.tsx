...
import UserTwo from "../../image/user/user-02.png";
import UserThree from "../../image/user/user-03.png";
import UserFour from "../../image/user/user-04.png";
  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      <li className="relative">
        ...
        {dropdownOpen && (
          <div
            className={`absolute -right-16 z-50 mt-2 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80`}
          >
