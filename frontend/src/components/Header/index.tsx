...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between sm:justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">
          ...
          >
            <span className="relative block h-5 w-5 cursor-pointer">
              ...
              <span className="absolute right-0 h-full w-full rotate-45">
                <span
                  className={`absolute left-2 top-0 block h-full w-1 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white ${
